...
%             end
            ...
            %
            fprintf('power %d, iteration %d, rate %3.1f percent, Err_e %d \n', power_id(m), j, 100*sum(any(new_grid,1))/sum(any(user_grid,1)), Err_e);
            %     for i = 1:t
...
%     hold on;
    ...
    output_str = strcat('error_rate_e_',num2str(power_id(m)), '_2', '.mat');
