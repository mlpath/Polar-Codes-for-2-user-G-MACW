...
% clear all
%
function  [R, user_grid, output] = find_secure_v22( filename, fidelity_par, block_length,  bob_sheet, eve_sheet )
% 
% clc
% clear all
%
...
length(valid_ts);
% 
% int_R now has closest rank function to our estimated rate vector
...
%
% return valid time slots and their respective integer rate vectors
output = [valid_ts, Rs', v_R(1:N,:)];%, v_R(N+1:end,:)]